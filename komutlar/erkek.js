...
data.set(`${üye.id}.cinsiyet`, "Erkek")
...
.setDescription(`${üye} adlı kullanıcına <@&765952504021123093> rolü veridi. Toplam **${kayıt_sayısı}** kişiyi kayıt ettin`)
.setColor('GREEN')
.setTimestamp())

üye.addRole(erkek).then(üye.removeRole(kayıtsız))
...
.setDescription(`Bir kullanıcı <@&${erkek}> olarak kayıt edildi. Kayıt eden yetkili toplam **${kayıt_sayısı}** kişiyi kayıt etmiş.`)
